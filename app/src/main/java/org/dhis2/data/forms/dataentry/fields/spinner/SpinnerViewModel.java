...
public abstract class SpinnerViewModel extends FieldViewModel implements FieldUiModel {
    ...
    public static SpinnerViewModel create(String id, String label, String hintFilterOptions, Boolean mandatory,
        ...
        return new AutoValue_SpinnerViewModel(id, label, mandatory, value, section, null, editable, null, null, description, objectStyle, null, DataEntryViewHolderTypes.OPTION_SET_SPINNER, R.layout.form_option_set, hintFilterOptions, optionSet, numberOfOptions == null ? 0 : numberOfOptions);
    }
